...
- **Details**: 
  ...
  - Display error messages if the date is in the future or missing for new registrations.
...
- Error messages will be displayed to the user if validation fails, particularly for future dates or missing 'date of joining'.
